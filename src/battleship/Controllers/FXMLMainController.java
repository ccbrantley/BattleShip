...
public class FXMLMainController implements Initializable {
     ...
     */
    @FXML
    private void updateScene(ActionEvent _event) throws IOException {
     ...
     @FXML
    private void logIn(ActionEvent _event) throws FileNotFoundException {
...
//*****************     GETTERS     *******************
    ...
    @FXML
    private void getInfo(ActionEvent _event) {
        this.apple.getInfo();
    }
